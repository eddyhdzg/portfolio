const copies = {
  landing: {
    ...
    abilities: {
      ...
      languages: {
        ...
        data: [
          ...
          {
            language: "Japanese",
            level: "Basic - JLPT N5 / Kanken 9 - Ongoing",
          },
        ],
      },
      education: {
    ...
    contact: {
      ...
      data: [
        {
          text: "github.com/eddyhdzg",
          url: "https://github.com/eddyhdzg",
        ...
        {
          text: "linkedin.com/in/eddyhdzg",
          url: "https://www.linkedin.com/in/eddyhdzg",
        ...
        {
          text: "leetcode.com/eddyhdzg",
          url: "https://leetcode.com/eddyhdzg",
          iconTitle: "Leetcode Icon",
          path: {
            d:
